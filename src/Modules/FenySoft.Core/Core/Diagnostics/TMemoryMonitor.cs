...
namespace FenySoft.Core.Diagnostics
{
    public class TMemoryMonitor
    {
        ...
        public TMemoryMonitor(bool monitorPagedMemorySize64, bool monitorWorkingSet64, bool monitorVirtualMemorySize64, int monitorPeriodInMilliseconds = 500)
        {
        ...
        public TMemoryMonitor(int monitorPeriodInMilliseconds = 500)
