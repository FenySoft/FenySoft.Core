...
{
    public class TCache<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
        //where TKey : IEquatable<TKey>//, IComparable<TKey>
    {
        ...
        public TCache(int capacity, IComparer<TKey> comparer)
        {
        ...
        public TCache(int capacity, IEqualityComparer<TKey> comparer)
        {
            this.capacity = capacity;
            Mapping = new Dictionary<TKey, LinkedListNode<KeyValuePair<TKey, TValue>>>(comparer);
        }

        public TCache(int capacity)
