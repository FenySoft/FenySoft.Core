...
{
    public interface ITOrderedSet<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        ITOrderedSet<TKey, TValue> Split(int count);
        void Merge(ITOrderedSet<TKey, TValue> set);
