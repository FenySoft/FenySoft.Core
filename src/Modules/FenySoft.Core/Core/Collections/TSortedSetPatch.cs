namespace FenySoft.Core.Collections
{
    ...
    //    private const string ComparerName = "TComparer";
    //    private int count;
    ...
    //    {
    //        this.comparer = TComparer<T>.Default;
    //    }
    ...
    //        : this(collection, TComparer<T>.Default)
    //    {
    //    }
    ...
    //    {
    //        return set1.TComparer.Equals(set2.TComparer);
    //    }
    ...
    //        info.AddValue("TComparer", this.comparer, typeof(IComparer<T>));
    ...
    //    {
    //        if (this.TComparer.Compare(lowerValue, upperValue) > 0)
    //        {
    ...
    //                T max = this.Max;
    //                T min = this.Min;
    //                while ((!flag && !flag2) && (this.TComparer.Compare(enumerator2.Current, max) <= 0))
    //                {
    //                    int num2 = this.TComparer.Compare(enumerator.Current, enumerator2.Current);
    //                    if (num2 < 0)
    //                    {
    ...
    //            }
    //            this.comparer = (IComparer<T>)this.siInfo.GetValue("TComparer", typeof(IComparer<T>));
    ...
    //    {
    //        int cmp = TComparer.Compare(fromKey, toKey);
    //        if (cmp > 0)
    ...
    //        int from = Array.BinarySearch(arr, fromKey, TComparer);
    //        int fromIdx = from;
    //        if (fromIdx < 0)
    //        {
    //            fromIdx = ~fromIdx;
    ...
    //        int to = Array.BinarySearch(arr, fromIdx, Count - fromIdx, toKey, TComparer);
    //        int toIdx = to;
    //        if (toIdx < 0)
    //        {
    //            if (from == to)
    ...
    //            while (!flag && !flag2)
    //            {
    //                if (this.TComparer.Compare(enumerator.Current, enumerator2.Current) != 0)
    //                {
    //                    return false;
    //                }
    //                flag = !enumerator.MoveNext();
    ...
    //        SortedSetPatch<T> right = new SortedSetPatch<T>(this.TComparer);
    ...
    //                Array.Sort<T>(array, this.TComparer);
    ...
    //                while (this.MoveNext())
    //                {
    //                    if (this.tree.TComparer.Compare(this.Current, y) == 0)
    //                    {
    //                        return;
    //                    }
    //                }
    ...
    //                        return false;
    //                    }
    //                    if ((node.Left != null) && (!this.lBoundActive || (base.TComparer.Compare(this.min, node.Item) < 0)))
    //                    {
    //                        list.Add(node.Left);
    //                    }
    //                    if ((node.Right != null) && (!this.uBoundActive || (base.TComparer.Compare(this.max, node.Item) > 0)))
    //                    {
    //                        list.Add(node.Right);
    //                    }
    //                }
    ...
    //        {
    //            if (this.lBoundActive && (base.TComparer.Compare(this.min, lowerValue) > 0))
    //            {
    //                throw new ArgumentOutOfRangeException("lowerValue");
    //            }
    //            if (this.uBoundActive && (base.TComparer.Compare(this.max, upperValue) < 0))
    //            {
    ...
    //                    else
    //                    {
    //                        if (this.lBoundActive && (base.TComparer.Compare(this.min, root.Item) > 0))
    //                        {
    //                            root = root.Right;
    //                            continue;
    //                        }
    ...
    //                        else
    //                        {
    //                            if (this.lBoundActive && (base.TComparer.Compare(this.min, item.Item) > 0))
    //                            {
    //                                item = item.Right;
    //                                continue;
    //                            }
    ...
    //            {
    //                num++;
    //                if (base.TComparer.Compare(item, local) == 0)
    //                {
    //                    return num;
    //                }
    //            }
    ...
    //        {
    //            int num = this.lBoundActive ? base.TComparer.Compare(this.min, item) : -1;
    //            if (num > 0)
    //            {
    //                return false;
    //            }
    //            num = this.uBoundActive ? base.TComparer.Compare(this.max, item) : 1;
    //            if (num < 0)
    //            {
    //                return false;
    //            }
    ...
    //                ThrowHelper.ThrowSerializationException(ExceptionResource.Serialization_InvalidOnDeser);
    //            }
    //            base.comparer = (IComparer<T>)base.siInfo.GetValue("TComparer", typeof(IComparer<T>));
    ...
    //        {
    //            this.e_comparer = TEqualityComparer<T>.Default;
    //        }
    //        else
    //        {
