namespace FenySoft.Core.Compression
{
    public static class TCountCompression
    {
        ...
        /// <summary>
        /// Compress value of count by TCountCompression, and stores result in BinaryWriter
        /// </summary>
        ...
        /// <summary>
        /// Decompress a value compressed with TCountCompression by successively reading bytes from BinaryReader.
        /// </summary>       
