...
namespace FenySoft.Core.Data
{
    public class TSlotsBuilder
    {
        ...
        private static Type BuildTypeCodeDom(Type baseInterface, string className, string fieldsPrefix, params Type[] types)
        {
            ...
            var classNamespace = new CodeNamespace("FenySoft.Core.TData");
        ...
        public static Type BuildType(params Type[] types)
        {
            ...
            switch (types.Length)
            {
                case 01: return typeof(TSlots<>).MakeGenericType(types);
            ...
            return map.GetOrAdd(new TypeArray(types), BuildType(typeof(ISlots), "TSlots", "Slot", types));
        }
