...
{
    public class TListHelper<T>
    {
        public static readonly TListHelper<T> Instance = new TListHelper<T>();
    ...
    public static class TListExtensions
    {
        ...
        {
            return TListHelper<T>.Instance.GetArray(instance);
        }

        public static void SetArray<T>(this List<T> instance, T[] array)
        {
            TListHelper<T>.Instance.SetArray(instance, array);
        }

        public static void SetCount<T>(this List<T> instance, int count)
        {
            TListHelper<T>.Instance.SetCount(instance, count);
        }

        public static void IncrementVersion<T>(this List<T> instance)
        {
            TListHelper<T>.Instance.IncrementVersion(instance);
        }
