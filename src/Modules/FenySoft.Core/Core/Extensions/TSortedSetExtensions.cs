...
{
    public class TSortedSetHelper<T>
    {
        public static readonly TSortedSetHelper<T> Instance = new TSortedSetHelper<T>();
    ...
    public static class TSortedSetExtensions
    {
        public static bool TryGetValue<T>(this SortedSet<T> set, T key, out T value)
        {
            return TSortedSetHelper<T>.Instance.TryGetValue(set, key, out value);
        }
        ...
        {
            TSortedSetHelper<T>.Instance.ConstructFromSortedArray(set, array, index, count);
        }
        ...
        {
            return TSortedSetHelper<T>.Instance.Replace(set, item, onExist);
        }
        ...
        {
            return TSortedSetHelper<T>.Instance.GetViewBetween(set, lowerValue, upperValue, lowerBoundActive, upperBoundActive);
        }

        public static bool FindNext<T>(this SortedSet<T> set, T key, out T value)
        {
            var returnValue = TSortedSetHelper<T>.Instance.FindNext(set, key);
        ...
        {
            var returnValue = TSortedSetHelper<T>.Instance.FindPrev(set, key);
        ...
        {
            var returnValue = TSortedSetHelper<T>.Instance.FindAfter(set, key);
        ...
        {
            var returnValue = TSortedSetHelper<T>.Instance.FindBefore(set, key);
