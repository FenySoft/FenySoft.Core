...
namespace FenySoft.Core.Extensions
{
    ...
    public class TKeyValuePairHelper<TKey, TValue>
    {
        public static readonly TKeyValuePairHelper<TKey, TValue> Instance = new TKeyValuePairHelper<TKey, TValue>();
