...
{
    public class TLittleEndianByteArrayComparer : IComparer<byte[]>
    {
        public static readonly TLittleEndianByteArrayComparer Instance = new TLittleEndianByteArrayComparer();
