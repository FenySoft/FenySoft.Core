...
{
    public class TBigEndianByteArrayEqualityComparer : IEqualityComparer<byte[]>
    {
        public static readonly TBigEndianByteArrayEqualityComparer Instance = new TBigEndianByteArrayEqualityComparer();
